package com.leidcool.lincchat.paper1201;
...
import com.leidcool.lincchat.commands.BukkitCommandRegistrar;
import com.leidcool.lincchat.commands.CommandBindings;
...
public final class LincChatPlugin extends JavaPlugin {
    ...
    private void registerCommands() {
        BukkitCommandRegistrar.registerAll(this, CommandBindings.collect(channelManager, profileCache, ignoreService,
                spyService, muteService, colorPermissionPolicy, mainConfig, messagesConfig, formatEngine,
                chatPauseState, this::reload, this::debugLines));
    }
